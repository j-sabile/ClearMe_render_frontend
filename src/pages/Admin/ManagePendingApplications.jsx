...
function ManagePendingApplications() {
  ...
  useEffect(() => {
    fetch(`${process.env.REACT_APP_API}/get-student-application-admin`, { method: "POST", credentials: "include" })
      .then((res) => res.json())
  ...
  const handleReject = async () => {
    await fetch(`${process.env.REACT_APP_API}/reject-student-application-admin`, {
      method: "POST",
  ...
  const handleApprove = async (applicationId) => {
    await fetch(`${process.env.REACT_APP_API}/clear-student-application`, {
      method: "POST",
      headers: { "Content-Type": "application/json" },
      credentials: "include",
