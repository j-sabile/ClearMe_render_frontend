function ReturnPopUp({ handleCloseModal2, applicationId }) {
  const handleReturn = async (e) => {
    ...
    await fetch(`${process.env.REACT_APP_API}/return-application-adviser`, {
      method: "POST",
  ...
  return (
    <>
      ...
      <form>
        <label htmlFor="remark">Adviser Remark:</label>
        <br />
        <input type="text" placeholder="Input Remark to Student" id="remark" name="remark" size="30" required />
        <br />
        <br />
