...
export default function ViewApplication() {
  ...
  const handleResubmitClearanceOfficer = async (e) => {
    ...
    var applicationDocu = {
      // create subject object to be passed to body
      studentId: student._id,
      current_step: 3,
      student_remark: studentRemark,
    };

    await fetch(`${process.env.REACT_APP_API}/add-student-submission-clearance-officer`, {
      method: "POST",
      headers: { "Content-Type": "application/json" },
      credentials: "include",
  ...
  const handleResubmitAdviser = async (e) => {
    ...
    await fetch(`${process.env.REACT_APP_API}/add-student-submission-adviser`, {
      method: "POST",
      headers: { "Content-Type": "application/json" },
      credentials: "include",
      body: JSON.stringify(applicationDocu),
    ...
    if (application.current_step === 1 || (application.current_step === 2 && application.status === "pending")) {
      ...
      return (
        <div className="form-container">
          ...
          <form>
            ...
            <br />
            <input type="text" id="link" name="link" className="github-input" required />
            <br />
            <label htmlFor="remark">Student Remark:</label>
            <br />
      ...
      return (
        <div className="form-container">
          ...
          <br></br>
          <form>
            <label htmlFor="student-remark">Student Remark:</label>
            <br />
            <input type="text" id="student-remark" name="student-remark" required />
            <br />
            <br />
