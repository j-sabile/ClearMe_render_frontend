...
export default function SingleNotif(props) {
      ...
      return (
        <>
          ...
          <div>
            <PDFDownloadLink
              document={
                <PDFDocument applicationId={props.id} dateGenerated={date} studentName={student_name} studentNumber={student.student_number} adviser={adviser_name} clearanceOfficer={"Admin"} />
              }
  ...
  return <div className="notif-item">{renderNotif(props)}</div>;
}
