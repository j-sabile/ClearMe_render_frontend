  ...
  const renderButtons = (status, appId) => {
    if (status === "pending" || status === "returned") {
      return (
        <>
          <td>
            <button className="btn btn-warning" style={{ pointerEvents: "none" }}>
              Pending
            </button>
          </td>
          <td>
      ...
      return (
        <>
          <td>
            <button className="btn btn-success" style={{ pointerEvents: "none" }}>
              Cleared
            </button>
          </td>
          <td>
            ...
            <div>
              <PDFDownloadLink
                document={
                  <PDFDocument applicationId={appId} dateGenerated={date} studentName={student_name} studentNumber={student.student_number} adviser={adviser_name} clearanceOfficer={"Admin"} />
                }
                fileName="approved_clearance.pdf">
      ...
      return (
        <>
          ...
          <td>
            <button type="button" className="btn btn-outline-secondary" style={{ pointerEvents: "none" }}>
              N/A
            </button>
          </td>
        </>
